#ifndef KB_DAVINCIRGB_H
#define KB_DAVINCIRGB_H
#include "Arduino.h"

#if defined(KB_DAVINCI_H) || defined(KB_DAVINCIRGB_H)
...
class KB_DAVINCIRGB {
	...
	public:
		KB_DAVINCIRGB();
		KB_DAVINCIRGB(byte r_pin, byte g_pin, byte b_pin, bool common_cathode=true);
		void begin();
