...
module.exports = function (Blockly) {
	...
	var music_colour = "#33cc33"; 
    var music_colour_song = "#00cc99";
	Blockly.Blocks['setup_nx2003_Music'] = {
		init: function () {
			this.appendDummyInput()
				...
				.appendField("Using setup Kid bright Davinci Music");
	...
	Blockly.Blocks['music_ice_cream'] = {
		init: function () {
			...
			this.setPreviousStatement(true, null);
			this.setNextStatement(true, null);
			this.setColour(music_colour_song);
	...
	Blockly.Blocks['music_cat'] = {
		init: function () {
			this.appendDummyInput()
				.appendField(new Blockly.FieldImage(`file:///${dirIcon}/static/icons/music.png`, 25, 25, { alt: "*", flipRtl: "FALSE" }))
				.appendField("Play Music :  Noo Malee and her Kitty");
			this.appendDummyInput()
	...
	Blockly.Blocks['music_conan'] = {
		init: function () {
			this.appendDummyInput()
				.appendField(new Blockly.FieldImage(`file:///${dirIcon}/static/icons/music.png`, 25, 25, { alt: "*", flipRtl: "FALSE" }))
				.appendField("Play Music :  Detective conan theme song");
			this.appendDummyInput()
			...
			this.setNextStatement(true, null);
			this.setColour(music_colour_song);
			this.setTooltip("detective conan theme song : tempo is 140");
			this.setHelpUrl("");
		}
	};
	...
	Blockly.Blocks['music_pirate'] = {
		init: function () {
			this.appendDummyInput()
				.appendField(new Blockly.FieldImage(`file:///${dirIcon}/static/icons/music.png`, 25, 25, { alt: "*", flipRtl: "FALSE" }))
				.appendField("Play Music : Pirates of the Caribbean");
			this.appendDummyInput()
				.appendField("         Note : A4,C5,D5,D5,D5,E5,F5,F5,F5,G5,E5,E5,D5,C5,C5,D5,A4,C5,D5,D5,D5");
			this.setPreviousStatement(true, null);
			this.setNextStatement(true, null);
			this.setColour(music_colour_song);
			this.setTooltip("He's Pirate - Pirates of the Caribbean : tempo is 200");
			this.setHelpUrl("");
		}
	};
	Blockly.Blocks['music_harry'] = {
		init: function () {
			this.appendDummyInput()
				.appendField(new Blockly.FieldImage(`file:///${dirIcon}/static/icons/music.png`, 25, 25, { alt: "*", flipRtl: "FALSE" }))
				.appendField("Play Music : Harry's theme song ");
			this.appendDummyInput()
				.appendField("         Note : B4,E5,G5,F#5,E5,B5,A5,F#5,E5,G5,F#5,Eb5,F5,B4,G4,B4");
			this.setPreviousStatement(true, null);
			this.setNextStatement(true, null);
			this.setColour(music_colour_song);
			this.setTooltip("Harry's theme song : tempo is 88");
			this.setHelpUrl("");
		}
	};
};