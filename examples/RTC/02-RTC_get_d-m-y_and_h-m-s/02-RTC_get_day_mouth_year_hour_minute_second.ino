...
void loop() {
  ...
  Serial.println();
  oled1.setFont(ArialMT_Plain_10);
  oled1.drawString(0, 0, String((get_year)));
  oled1.setFont(ArialMT_Plain_10);
  oled1.drawString(0, 10, String((get_mouth)));
  oled1.setFont(ArialMT_Plain_10);
  oled1.drawString(0, 20, String((get_day)));
  oled1.setFont(ArialMT_Plain_10);
  oled1.drawString(0, 30, String((get_hour)));
  oled1.setFont(ArialMT_Plain_10);
  oled1.drawString(0, 40, String((get_minute)));
  oled1.setFont(ArialMT_Plain_10);
  oled1.drawString(0, 50, String((get_second)));
  oled1.display();
}
