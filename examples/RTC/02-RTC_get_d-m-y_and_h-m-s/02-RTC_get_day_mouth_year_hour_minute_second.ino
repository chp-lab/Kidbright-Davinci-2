...
void loop() {
  ...
  oled1.setTextSize(1);
  oled1.setCursor(0, 0);
  oled1.print(((String((get_dateTime)))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 10);
  oled1.print(((String((get_year)))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 20);
  oled1.print(((String((get_mouth)))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 30);
  oled1.print(((String((get_day)))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 40);
  oled1.print(((String((get_hour)))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 50);
  oled1.print(((String((get_minute)))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 60);
  oled1.print(((String((get_second)))));
  oled1.display();
  delay(500);
}
