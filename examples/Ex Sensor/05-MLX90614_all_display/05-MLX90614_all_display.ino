...
void loop() {
  ...
  oled1.setTextSize(1);
  oled1.setCursor(0, 0);
  oled1.print(((String("Obj : ") + String((mlx90614_1.readObjectTempC(0))) +
                String("C"))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 15);
  oled1.print(((String("Amb : ") + String((mlx90614_1.readAmbientTempC(0))) +
                String("C"))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 30);
  oled1.print(((String("Obj : ") + String((mlx90614_1.readObjectTempF(0))) +
                String("F"))));
  oled1.setTextSize(1);
  oled1.setCursor(0, 45);
  oled1.print(((String("Amb : ") + String((mlx90614_1.readAmbientTempF(0))) +
                String("F"))));
  oled1.display();
  delay(500);
}